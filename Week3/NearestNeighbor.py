...
def load_data(filename):
    ...
    return raw[:, :4].astype(float), raw[:,4].astype(str) #Return Data, Labels
...
#Find the closest neighbor and corresponding label
#Find index of smallest distance of training data per row (element of test data).
